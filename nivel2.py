...
imagen_fondo = pygame.image.load("images/estrellas/background_glacial_mountains.png").convert()
...
def nivel_2():
    ...
    player_1 = Player(x=200, y=100, speed_walk=6, speed_run=12, gravity=14, jump_power=30, frame_rate_ms=100,
    ...
    enemy_list = []
    enemy_list.append(Enemy(x=800, y=100, speed_walk=10, speed_run=8, gravity=8, frame_rate_ms=50,
                           move_rate_ms=50, jump_power=30, jump_height=140, p_scale=0.08,movimiento=None,tipo_enemigo=True))
    enemy_list.append(Enemy(x=380, y=200, speed_walk=6, speed_run=8, gravity=8, frame_rate_ms=50,
                           move_rate_ms=50, jump_power=30, jump_height=140, p_scale=0.08,movimiento=None,tipo_enemigo=True))
    enemy_list.append(Enemy(x=1400, y=200, speed_walk=6, speed_run=8, gravity=8, frame_rate_ms=50,
                           move_rate_ms=50, jump_power=30, jump_height=140, p_scale=0.08,movimiento=None,tipo_enemigo=True))
    enemy_list.append(Enemy(x=600, y=450, speed_walk=6, speed_run=8, gravity=8, frame_rate_ms=50,
                           move_rate_ms=50, jump_power=30, jump_height=140, p_scale=0.08,movimiento=None,tipo_enemigo=True))
    ...
    with open("nivel2.json", "r") as archivo:
    ...
    star_list = []
    star_list.append(Star(x=610, y=100, width=50, height=50, type=1))
    star_list.append(Star(x=950, y=300, width=50, height=50, type=1))
    star_list.append(Star(x=250, y=490, width=50, height=50, type=1))
